...
class HomeRepositoryImpl @Inject constructor(
    ...
    override suspend fun getHomeFeed(category: String?): Resource<List<HomeSection>> {

        return try {

            val response = api.getHomeFeed(category)
            val homeFeed = response.data!!.toDomain()

            Resource.Success(homeFeed)
